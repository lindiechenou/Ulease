...
import { Button, Input, StyleService, useStyleSheet,TopNavigation, TopNavigationAction } from '@ui-kitten/components';
import { KeyboardAvoidingView } from './extra/keyboard-avoiding-view.component';
import { Chat } from './extra/chat.component';
import { AttachmentsMenu } from './extra/attachments-menu.component';
import { MicIcon, PaperPlaneIcon, PlusIcon, BackIcon } from './extra/icons';
...
export const chat1= ({navigation}): React.ReactElement => {
  ...
  return (
    ...
    <React.Fragment>
      <TopNavigation title='Message' alignment='center' accessoryLeft={BackAction}/>
      <Chat
        style={styles.chat}
